...
<aside class="aside">
    <div class="sidebar-container">
        <div class="flex_col">
            ...
            <div class="flex_col2">
                <button class="<%=pagenum==1?"btn1":"btn2" %>" onclick="location.assign('<%=request.getContextPath()%>/admin/home.do?pagenum=1')">
                    <h4>관리자페이지</h4>
                </button>
                <button class="<%=pagenum==2?"btn1":"btn2" %>" onclick="location.assign('<%=request.getContextPath()%>/admin/noticelist.do?pagenum=2')">
                    <h4>공지사항</h4>
                </button>
                <button class="<%=pagenum==3?"btn1":"btn2" %>" onclick="location.assign('<%=request.getContextPath()%>/admin/faqlist.do?pagenum=3')">
                    <h4>faq</h4>
                </button>
                  <button class="<%=pagenum==4?"btn1":"btn2" %>" onclick="location.assign('<%=request.getContextPath()%>/admin/inquirylist.do?pagenum=4')">
                    <h4>1:1문의</h4>
                </button>
                 <button class="<%=pagenum==5?"btn1":"btn2" %>" onclick="location.assign('<%=request.getContextPath()%>/admin/reportlist.do?pagenum=5')">
                    <h4>신고내역</h4>
                </button>
           </div>
           <br>
           <div class="flex_col1">
            ...
            <div class="flex_col2">
                <button class="<%=pagenum==6?"btn1":"btn2" %>" onclick="location.assign('<%=request.getContextPath()%>/admin/artistlist.do?pagenum=6')">
                    <h4>아티스트</h4>
                </button>
                <button class="<%=pagenum==7?"btn1":"btn2" %>" onclick="location.assign('<%=request.getContextPath()%>/admin/grouplist.do?pagenum=7')">
                    <h4>그룹</h4>
                </button>
                <button class="<%=pagenum==8?"btn1":"btn2" %>" onclick="location.assign('<%=request.getContextPath()%>/admin/memberlist.do?pagenum=8')">
                    <h4>회원</h4>
                </button>
                  <button class="<%=pagenum==9?"btn1":"btn2" %>" onclick="location.assign('<%=request.getContextPath()%>/admin/unactivememberlist.do?pagenum=9')">
                    <h4>제재내역</h4>
                </button>
           </div>
           <br>
           <div class="flex_col1">
            ...
            <div class="flex_col2">
                <button class="<%=pagenum==10?"btn1":"btn2" %>" onclick="location.assign('<%=request.getContextPath()%>/admin/feedlist.do?pagenum=10')">
                    <h4>피드</h4>
                </button>
           </div>
           <br>
