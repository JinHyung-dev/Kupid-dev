<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="java.util.List,com.kupid.admin.report.model.dto.Report" %>
<%
	...
	<h1>
			<div>
	        	...
	        	<div id="search-reported_member">
					<form action="<%=request.getContextPath()%>/admin/searchreport.do">
	...
	<table class="table-size">
		...
		<%if(report!=null){ %>
			...
			<tr>
				...
				<td><button onclick="location.assign('<%=request.getContextPath()%>/admin/reportview.do?no=<%=rp.getReportNo()%>')">(상세내용)처리</button></td>
			</tr>
			<%} 
		}else{%>
