<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="EUC-KR"%>
<%@ page import="com.kupid.admin.inquiry.model.dto.Inquiry,com.kupid.admin.answer.model.dto.Answer" %>
<%
            ...
            <div class="flex_col">
                ...
                <div class="content-container">
                    ...
                    <div class="flex_row">
                        ...
                        <form action="<%=request.getContextPath()%>/admin/answerupdateend.do?no=<%=ans.getAnswerNO()%>" method="post">
                       	<div class="content-container">
                            <h3>답변 제목</h3>
                            	<div class="input_box">
