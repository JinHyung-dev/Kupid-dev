...
import com.kupid.admin.artist.service.ArtistService;
 ...
 */
@WebServlet("/admin/searchArtist.do")
public class SearchArtistServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/WEB-INF/views/admin/artist/artistlist.jsp").forward(request, response);
	}
