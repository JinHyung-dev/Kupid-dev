package com.kupid.admin.inquiry.controller;
 ...
 */
@WebServlet("/admin/inquirylist.do")
...
//		String writer=inq.get(7);
		...
		request.getRequestDispatcher("/WEB-INF/views/admin/inquiry/inquirylist.jsp").forward(request, response);
	}
